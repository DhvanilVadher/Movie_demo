...
@Entity(tableName = "Stored_Movies_Popular")
public class MovieWrapperPopular {
    @PrimaryKey
    ...
    public MovieWrapperPopular(int movie_id, MovieModel movieModel) {
