...
@Entity(tableName = "Stored_Movies_Playing")
public class MovieWrapperPlaying {
    @PrimaryKey
    ...
    public MovieWrapperPlaying(int movie_id, MovieModel movieModel) {
